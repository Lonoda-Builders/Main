...
The primary Build WhatsApp group icon lives in this folder, with the remaining concepts kept as alternatives.
...
![Main WhatsApp group icon](./build-whatsapp-icon.svg)
